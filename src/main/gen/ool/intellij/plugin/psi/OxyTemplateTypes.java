...
public interface OxyTemplateTypes {
  ...
  IElementType T_INNER_TEMPLATE_ELEMENT = new OuterLanguageElementType("T_INNER_TEMPLATE_ELEMENT", OxyTemplate.INSTANCE);
  ...
  IElementType T_OUTER_TEMPLATE_ELEMENT = new OuterLanguageElementType("T_OUTER_TEMPLATE_ELEMENT", OxyTemplate.INSTANCE);
