...
public class BlockCloseStatementImpl extends OxyTemplatePsiElementImpl implements BlockCloseStatement {

  public BlockCloseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OxyTemplateElementVisitor visitor) {
    visitor.visitBlockCloseStatement(this);
  }
