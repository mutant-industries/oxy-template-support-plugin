...
public class DirectiveOpenStatementImpl extends OxyTemplatePsiElementImpl implements DirectiveOpenStatement {

  public DirectiveOpenStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OxyTemplateElementVisitor visitor) {
    visitor.visitDirectiveOpenStatement(this);
  }
