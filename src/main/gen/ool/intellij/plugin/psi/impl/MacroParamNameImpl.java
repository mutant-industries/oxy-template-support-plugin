...
public class MacroParamNameImpl extends OxyTemplatePsiElementImpl implements MacroParamName {

  public MacroParamNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OxyTemplateElementVisitor visitor) {
    visitor.visitMacroParamName(this);
  }
