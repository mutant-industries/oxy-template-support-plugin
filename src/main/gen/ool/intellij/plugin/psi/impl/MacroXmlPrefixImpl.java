...
public class MacroXmlPrefixImpl extends OxyTemplatePsiElementImpl implements MacroXmlPrefix {

  public MacroXmlPrefixImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull OxyTemplateElementVisitor visitor) {
    visitor.visitMacroXmlPrefix(this);
  }
