...
*/
public class MacroNameDocumentationProvider extends AbstractDocumentationProvider
{
    @Nullable
    @Override
    ...
    public PsiElement getDocumentationElementForLookupItem(PsiManager psiManager, Object object, PsiElement element)
    {
        ...
        {
            MacroCall macroCall = PsiTreeUtil.getParentOfType(element, MacroCall.class);    // TODO idea 13 fix
