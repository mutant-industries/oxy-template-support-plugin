 ...
 */
public class OxyTemplateTemplateHighlighter extends LayeredLexerEditorHighlighter
{
    public OxyTemplateTemplateHighlighter(@Nullable Project project, @Nullable VirtualFile virtualFile, @NotNull EditorColorsScheme colors)
    {
        super(new OxyTemplateHighlighter(/*project*/), colors);
        ...
        registerLayer(OxyTemplateTypes.T_TEMPLATE_HTML_CODE, new LayerDescriptor(markupHighlighter, ""));
