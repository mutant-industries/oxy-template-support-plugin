 ...
 */
public class InnerJsJavaTypeConvertor extends NashornJSTypeEvaluatorHelper
{
    // TODO temp code, see https://youtrack.jetbrains.com/issue/WEB-16383
    public boolean addTypeFromResolveResult(JSTypeEvaluator evaluator, JSReferenceExpression expression,
                                            PsiElement parent, PsiElement result, boolean hasSomeType)
    {
        JSType type;
        ...
        return super.addTypeFromResolveResult(evaluator, expression, parent, result, hasSomeType);
    }
    // -------------------------------------------------------------------
    ...
    public static String simplify(@NotNull String javaFqn)
    {
        ...
        {
            return JSCommonTypeNames.BOOL_TYPE_NAME;
        }
