    ...
    public void visitJSTypeImpl(JSType type)
    {
                ...
                && resolvedClass.getQualifiedName() != null)
        {
            ...
            try
            {
                ...
                field.set(type, InnerJsJavaTypeConvertor.simplify(resolvedClass.getQualifiedName()));
            ...
            catch (NoSuchFieldException | IllegalAccessException e)
            {
                try
                {
                    // changed sometime between 141.713 and 141.913 (type -> myType)
                    Field field = type.getClass().getDeclaredField("type");
                    field.setAccessible(true);
                    field.set(type, InnerJsJavaTypeConvertor.simplify(resolvedClass.getQualifiedName()));
